...
namespace Backend.RazorModels
{
    ...
    public class TravelExpenseRazorModel
    {
        #region Constructor
        ...
        public TravelExpenseAdapterModel CurrentRecord { get; set; } = new TravelExpenseAdapterModel();
        public TravelExpenseAdapterModel CurrentNeedDeleteRecord { get; set; } = new TravelExpenseAdapterModel();
        ...
        private readonly ITravelExpenseService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new TravelExpenseAdapterModel();
                #region 針對新增的紀錄所要做的初始值設定商業邏輯
                CurrentRecord.ApplyDate = DateTime.Now.Date;
                #endregion
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<TravelExpenseAdapterModel> args)
        {
            TravelExpenseAdapterModel item = args.RowData as TravelExpenseAdapterModel;
