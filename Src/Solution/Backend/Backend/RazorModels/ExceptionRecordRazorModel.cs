...
namespace Backend.RazorModels
{
    ...
    public class ExceptionRecordRazorModel
    {
        #region Constructor
        ...
        public ExceptionRecordAdapterModel CurrentRecord { get; set; } = new ExceptionRecordAdapterModel();
        public ExceptionRecordAdapterModel CurrentNeedDeleteRecord { get; set; } = new ExceptionRecordAdapterModel();
        ...
        private readonly IExceptionRecordService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new ExceptionRecordAdapterModel();
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<ExceptionRecordAdapterModel> args)
        {
            ExceptionRecordAdapterModel item = args.RowData as ExceptionRecordAdapterModel;
            if (args.CommandColumn.ButtonOption.IconCss == ButtonIdHelper.ButtonIdEdit ||
                args.CommandColumn.ButtonOption.IconCss == ButtonIdHelper.ButtonIdDetail)
            {
