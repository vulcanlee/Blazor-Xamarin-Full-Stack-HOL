...
namespace Backend.RazorModels
{
    ...
    public class OnCallPhoneRazorModel
    {
        #region Constructor
        public OnCallPhoneRazorModel(IOnCallPhoneService CurrentService,
           ...
           IMapper Mapper)
        {
            ...
            mapper = Mapper;
            OnCallPhoneSort.Initialization(SortConditions);
        ...
        public OnCallPhoneAdapterModel CurrentRecord { get; set; } = new OnCallPhoneAdapterModel();
        public OnCallPhoneAdapterModel CurrentNeedDeleteRecord { get; set; } = new OnCallPhoneAdapterModel();
        ...
        private readonly IOnCallPhoneService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new OnCallPhoneAdapterModel();
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<OnCallPhoneAdapterModel> args)
        {
            OnCallPhoneAdapterModel item = args.RowData as OnCallPhoneAdapterModel;
