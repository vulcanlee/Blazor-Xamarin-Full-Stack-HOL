...
namespace Backend.RazorModels
{
    ...
    public class TravelExpenseDetailRazorModel
    {
        #region Constructor
        public TravelExpenseDetailRazorModel(ITravelExpenseDetailService CurrentService,
           ...
           IMapper Mapper)
        {
            ...
            mapper = Mapper;
            TravelExpenseDetailSort.Initialization(SortConditions);
        ...
        public TravelExpenseDetailAdapterModel CurrentRecord { get; set; } = new TravelExpenseDetailAdapterModel();
        public TravelExpenseDetailAdapterModel CurrentNeedDeleteRecord { get; set; } = new TravelExpenseDetailAdapterModel();
        ...
        private readonly ITravelExpenseDetailService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new TravelExpenseDetailAdapterModel();
                #region 針對新增的紀錄所要做的初始值設定商業邏輯
                #endregion
                EditRecordDialogTitle = "新增紀錄";
                isNewRecordMode = true;
                IsShowEditRecord = true;
                CurrentRecord.TravelExpenseId = Header.Id;
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<TravelExpenseDetailAdapterModel> args)
        {
            TravelExpenseDetailAdapterModel item = args.RowData as TravelExpenseDetailAdapterModel;
