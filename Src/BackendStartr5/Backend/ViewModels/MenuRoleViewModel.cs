...
namespace Backend.ViewModels
{
    ...
    public class MenuRoleViewModel
    {
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public MenuRoleAdapterModel CurrentRecord { get; set; } = new MenuRoleAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public MenuRoleAdapterModel CurrentNeedDeleteRecord { get; set; } = new MenuRoleAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly IMenuRoleService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new MenuRoleAdapterModel();
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<MenuRoleAdapterModel> args)
        {
            MenuRoleAdapterModel item = args.RowData as MenuRoleAdapterModel;
            ...
            else if (args.CommandColumn.ButtonOption.IconCss == ButtonIdHelper.ButtonIdShowDetailOfMaster)
            {
                ...
                ShowMoreDetailsRecordDialogTitle = "單明細管理功能名稱";
