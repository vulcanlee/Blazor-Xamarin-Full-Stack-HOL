namespace Backend.Adapters
{
    ...
    public partial class ExceptionRecordAdapter : DataAdaptor<IExceptionRecordService>
    {
        [Parameter]
        ...
        public override async Task<object> ReadAsync(DataManagerRequest dataManagerRequest, string key = null)
        {
            ...
            try
            {
                DataRequestResult<ExceptionRecordAdapterModel> adaptorModelObjects = await Service.GetAsync(dataRequest);
            ...
            {
                return new DataResult() { Result = new List<ExceptionRecordAdapterModel>(), Count = 0 };
            }
            #endregion
        }
    }
