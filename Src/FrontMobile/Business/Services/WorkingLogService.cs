...
{
    public class WorkingLogService : BaseWebAPI<WorkingLogDto>
    {
        private readonly AppStatus appStatus;

        public WorkingLogService(AppStatus appStatus)
            : base()
        {
            this.Url = "/api/WorkingLog";
        ...
        public async Task<APIResult> PostAsync(WorkingLogDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
        ...
        public async Task<APIResult> PutAsync(WorkingLogDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
            ApiResultIsCollection = false;
        ...
        public async Task<APIResult> DeleteAsync(WorkingLogDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
            ApiResultIsCollection = false;
