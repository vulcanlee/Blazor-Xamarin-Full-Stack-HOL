...
{
    public class TravelExpenseService : BaseWebAPI<TravelExpenseDto>
    {
        private readonly AppStatus appStatus;

        public TravelExpenseService(AppStatus appStatus)
            : base()
        {
            this.Url = "/api/TravelExpense";
        ...
        public async Task<APIResult> PostAsync(TravelExpenseDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
        ...
        public async Task<APIResult> PutAsync(TravelExpenseDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
            ApiResultIsCollection = false;
        ...
        public async Task<APIResult> DeleteAsync(TravelExpenseDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
            ApiResultIsCollection = false;
