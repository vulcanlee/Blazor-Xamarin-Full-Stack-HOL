...
{
    public class WorkingLogDetailService : BaseWebAPI<WorkingLogDetailDto>
    {
        private readonly AppStatus appStatus;

        public WorkingLogDetailService(AppStatus appStatus)
            : base()
        {
            this.Url = "/api/WorkingLogDetail";
        ...
        public async Task<APIResult> PostAsync(WorkingLogDetailDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
        ...
        public async Task<APIResult> PutAsync(WorkingLogDetailDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
            ApiResultIsCollection = false;
        ...
        public async Task<APIResult> DeleteAsync(WorkingLogDetailDto item)
        {
            #region 指定此次呼叫 Web API 要執行參數
            Token = appStatus.SystemStatus.Token;
            ApiResultIsCollection = false;
