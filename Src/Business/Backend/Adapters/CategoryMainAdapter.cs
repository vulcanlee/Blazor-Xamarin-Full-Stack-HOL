namespace Backend.Adapters
{
    ...
    public partial class CategoryMainAdapter : DataAdaptor<ICategoryMainService>
    {
        [Parameter]
        ...
        public override async Task<object> ReadAsync(DataManagerRequest dataManagerRequest, string key = null)
        {
            ...
            #region 發出查詢要求
            DataRequestResult<CategoryMainAdapterModel> adaptorModelObjects = await Service.GetAsync(dataRequest);
