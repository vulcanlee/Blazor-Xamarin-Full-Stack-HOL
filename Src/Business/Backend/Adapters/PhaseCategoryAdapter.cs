namespace Backend.Adapters
{
    ...
    public partial class PhaseCategoryAdapter : DataAdaptor<IPhaseCategoryService>
    {
        [Parameter]
        ...
        public override async Task<object> ReadAsync(DataManagerRequest dataManagerRequest, string key = null)
        {
            ...
            #region 發出查詢要求
            DataRequestResult<PhaseCategoryAdapterModel> adaptorModelObjects = await Service.GetAsync(dataRequest);
