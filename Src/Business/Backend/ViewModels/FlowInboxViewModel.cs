...
namespace Backend.ViewModels
{
    ...
    public class FlowInboxViewModel
    {
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public FlowInboxAdapterModel CurrentRecord { get; set; } = new FlowInboxAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public FlowInboxAdapterModel CurrentNeedDeleteRecord { get; set; } = new FlowInboxAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly IFlowInboxService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new FlowInboxAdapterModel();
