...
namespace Backend.ViewModels
{
    ...
    public class FlowHistoryViewModel
    {
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public FlowHistoryAdapterModel CurrentRecord { get; set; } = new FlowHistoryAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public FlowHistoryAdapterModel CurrentNeedDeleteRecord { get; set; } = new FlowHistoryAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly IFlowHistoryService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new FlowHistoryAdapterModel();
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<FlowHistoryAdapterModel> args)
        {
            FlowHistoryAdapterModel item = args.RowData as FlowHistoryAdapterModel;
