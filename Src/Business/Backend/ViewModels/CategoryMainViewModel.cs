...
namespace Backend.ViewModels
{
    ...
    public class CategoryMainViewModel
    {
        #region Constructor
        public CategoryMainViewModel(ICategoryMainService CurrentService,
           ...
           TranscationResultHelper transcationResultHelper)
        {
            ...
            mapper = Mapper;
            TranscationResultHelper = transcationResultHelper;
            CategoryMainSort.Initialization(SortConditions);
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public CategoryMainAdapterModel CurrentRecord { get; set; } = new CategoryMainAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public CategoryMainAdapterModel CurrentNeedDeleteRecord { get; set; } = new CategoryMainAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly ICategoryMainService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new CategoryMainAdapterModel();
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<CategoryMainAdapterModel> args)
        {
            CategoryMainAdapterModel item = args.RowData as CategoryMainAdapterModel;
        ...
        #region 紀錄啟用或停用
        public async Task DisableIt(CategoryMainAdapterModel item)
        {
            await CurrentService.DisableIt(item);
            dataGrid.RefreshGrid();
        }
        public async Task EnableIt(CategoryMainAdapterModel item)
        {
