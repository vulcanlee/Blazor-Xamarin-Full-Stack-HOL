...
namespace Backend.ViewModels
{
    ...
    {
        #region Constructor
        public CategorySubViewModel(ICategorySubService CurrentService,
           ...
           TranscationResultHelper transcationResultHelper)
        {
            ...
            mapper = Mapper;
            TranscationResultHelper = transcationResultHelper;
            CategorySubSort.Initialization(SortConditions);
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public CategorySubAdapterModel CurrentRecord { get; set; } = new CategorySubAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public CategorySubAdapterModel CurrentNeedDeleteRecord { get; set; } = new CategorySubAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly ICategorySubService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new CategorySubAdapterModel();
                #region 針對新增的紀錄所要做的初始值設定商業邏輯
                #endregion
                EditRecordDialogTitle = "新增紀錄";
                isNewRecordMode = true;
                IsShowEditRecord = true;
                CurrentRecord.CategoryMainId = Header.Id;
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<CategorySubAdapterModel> args)
        {
            CategorySubAdapterModel item = args.RowData as CategorySubAdapterModel;
        ...
        #region 啟用/停用
        public async Task DisableIt(CategorySubAdapterModel item)
        {
