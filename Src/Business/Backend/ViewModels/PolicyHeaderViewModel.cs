...
namespace Backend.ViewModels
{
    ...
    public class PolicyHeaderViewModel
    {
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public PolicyHeaderAdapterModel CurrentRecord { get; set; } = new PolicyHeaderAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public PolicyHeaderAdapterModel CurrentNeedDeleteRecord { get; set; } = new PolicyHeaderAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly IPolicyHeaderService CurrentService;
        ...
        public async Task EnableIt(PolicyHeaderAdapterModel item)
        {
