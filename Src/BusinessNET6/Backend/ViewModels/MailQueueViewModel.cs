...
namespace Backend.ViewModels
{
    ...
    public class MailQueueViewModel
    {
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public MailQueueAdapterModel CurrentRecord { get; set; } = new MailQueueAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public MailQueueAdapterModel CurrentNeedDeleteRecord { get; set; } = new MailQueueAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly IMailQueueService CurrentService;
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<MailQueueAdapterModel> args)
        {
            MailQueueAdapterModel item = args.RowData as MailQueueAdapterModel;
