...
namespace Backend.ViewModels
{
    ...
    public class MenuDataViewModel
    {
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public MenuDataAdapterModel CurrentRecord { get; set; } = new MenuDataAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public MenuDataAdapterModel CurrentNeedDeleteRecord { get; set; } = new MenuDataAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly IMenuDataService CurrentService;
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<MenuDataAdapterModel> args)
        {
            MenuDataAdapterModel item = args.RowData as MenuDataAdapterModel;
        ...
        public async Task DisableIt(MenuDataAdapterModel item)
        {
            await CurrentService.DisableIt(item);
            dataGrid.RefreshGrid();
        }
        public async Task EnableIt(MenuDataAdapterModel item)
        {
