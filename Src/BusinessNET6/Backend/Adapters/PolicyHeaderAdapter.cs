namespace Backend.Adapters
{
    ...
    public partial class PolicyHeaderAdapter : DataAdaptor<IPolicyHeaderService>
    {
        [Parameter]
        ...
        public override async Task<object> ReadAsync(DataManagerRequest dataManagerRequest, string key = null)
        {
            ...
            #region 發出查詢要求
            DataRequestResult<PolicyHeaderAdapterModel> adaptorModelObjects = await Service.GetAsync(dataRequest);
